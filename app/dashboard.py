        ...
        class SimpleForecastEngine:
            ...
            def __init__(self, config_path: str = None):
                ...
                try:
                    ...
                    self.config = {
                        'data': {'processed_path': os.path.join(project_root, 'data', 'processed', 'forecasting_data.parquet')},
                        'model': {
...
page = st.sidebar.selectbox(
    "Navigate",
    ["Dashboard", "Forecast Generator", "Data Analyzer", "Analytics"]
)
